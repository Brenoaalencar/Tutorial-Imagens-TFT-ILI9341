...
void setup(void)
{
    ...
    //Cole os hexadecimais dentro das chaves abaixo. Caso use o arquivo .h, delete a linha abaixo e crie o arquivo .h
    const uint16_t  PROGMEM logo[] = {};
  
    //Os parâmetros da função são as posições x,y de onde se começa a imagem, a array logo e as dimensões da imagem
